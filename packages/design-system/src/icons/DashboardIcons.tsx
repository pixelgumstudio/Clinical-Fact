...
// Gradient cards for report
export const GradientCardIcon: React.FC<{ variant: 'green' | 'yellow' | 'red' | 'blue' }> = ({ variant }) => {
  ...
  return null; // This is just for type reference, actual gradient handled in component
};
