...
export const Avatar: React.FC<AvatarProps> = ({
  ...
  name,
  size = 'medium',
  backgroundColor = theme.colors.yale[600],
  ...
  // Size configurations — confirmed 2026-07-28 against the real avatar
  // container exports ("Small", "Medium(32px)", "Large(40px)", "Xlarge(48px)")
  const sizeConfig = {
    small: { container: 24, text: theme.typography.fontSize.xs, status: 6 },
    medium: { container: 32, text: theme.typography.fontSize.sm, status: 8 },
    large: { container: 40, text: theme.typography.fontSize.base, status: 10 },
    xlarge: { container: 48, text: theme.typography.fontSize.lg, status: 12 },
  };
