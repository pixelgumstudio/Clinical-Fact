...
const connection = new IORedis(redisUrl, {
  ...
  // Explicitly set family to 4 to use IPv4 instead of trying IPv6 first
  family: 4,
});
...
export const transcriptionWorker = new Worker('transcriptionQueue', async (job) => {
  ...
  // The processYouTubeNote function contains all the logic for extraction, transcription, and final save.
