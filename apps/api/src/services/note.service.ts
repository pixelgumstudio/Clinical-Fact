 ...
 * @returns {Promise<INote[]>} - A list of notes.
 */
...
/**
 * @description Get a single note by its ID, ensuring it belongs to the user.
 * @param {string} userId - The ID of the user.
 * @param {string} noteId - The ID of the note.
 * @returns {Promise<INote | null>} - The note, or null if not found.
 */
export const getNoteById = async (userId: string, noteId: string): Promise<INote | null> => {
