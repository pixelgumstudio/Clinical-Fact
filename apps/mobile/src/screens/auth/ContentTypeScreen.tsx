...
import { useSignupStore, CONTENT_TYPE_OPTIONS } from '../../store/signupStore';

type ContentTypeScreenNavigationProp = NativeStackNavigationProp<AuthStackParamList, 'ContentType'>;
...
export const ContentTypeScreen = () => {
  const navigation = useNavigation<ContentTypeScreenNavigationProp>();
  const { data, toggleContentType } = useSignupStore();
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      ...
      >
        <View style={styles.titleSection}>
          <Text style={styles.title}>
            Which type of content do{'\n'}you mostly use
            {data.firstName ? `, ${data.firstName}` : ''}?
          </Text>
          <Text style={styles.subtitle}>
            Select all that apply. This helps us customise your experience.
          </Text>
        </View>
              ...
              return (
                ...
                >
                  <TouchableOpacity
                    ...
                    onPress={() => toggleContentType(option.id)}
                    activeOpacity={0.75}
                  >
                    {cardContent}
                  </TouchableOpacity>
      ...
      <View style={styles.footer}>
        <TouchableOpacity
          style={[styles.continueButton, data.contentTypes.length === 0 && styles.continueButtonDisabled]}
          onPress={() => navigation.navigate('FeatureTranscribe')}
