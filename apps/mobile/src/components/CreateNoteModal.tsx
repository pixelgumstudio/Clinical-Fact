...
import { colors, spacing, typography, CloseIcon, RecordAudioGradientIcon, UploadAudioGradientIcon, YoutubeGradientIcon, PDFDocumentGradientIcon, CustomTextGradientIcon, ImageGradientIcon } from '@clinicalfact/design-system';
